...
IF NOT EXISTS (SELECT 1 FROM USER_TABLES WHERE TABLE_NAME = 'ROLE') THEN
...
MERGE INTO role t
USING (SELECT '0bc7b4e5-aa01-44d5-a114-8dc46e75c824' AS publicId FROM DUAL) s
...
MERGE INTO role t
USING (SELECT '7641965e-ae83-4c1f-b126-a21a908bfa22' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT 'b80abae7-a9f5-474d-8e75-808739f25b01' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT 'c76751d4-3f79-43bb-b468-13305bc5185f' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '3473be84-999c-42af-aafa-23b36d3b59e1' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT 'ed7f3167-b49e-4e3e-8dcc-f9c4e32f21ce' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT 'dab01602-1a19-4c7b-b665-afa1054f898b' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '89dc866d-92e4-4504-a087-e0b87402600a' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '90b1326d-fa73-4bf1-80f8-fb3a0187f9c8' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '28b8101c-e6f2-4018-8491-eedbd6e5d440' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT 'e5ebdfdd-0bc1-445e-9f76-b0edac37022d' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '94a402b1-f03f-4711-a3c9-978a74353e94' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '0a20f55e-af33-4304-b9e3-986c970d0a30' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '16571f12-b9e3-4103-9303-685be047b033' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '325a4f55-8408-44bc-ba64-e41df282a261' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT 'ddf99346-bfa1-4676-91e4-f6a41ffefa85' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT 'cba74225-ca33-46f9-a5f7-ddaf4b322e19' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '5e0c71e0-e067-4e61-8549-5f888882d205' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '38f14ea3-a651-4a52-a78c-74e388120856' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '5ebe3de7-3532-4c20-9800-3e4a45ca49fc' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT 'cde33f9f-3b72-4480-ad39-8134ceed1473' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '0d0b8bff-9e03-4f0b-b5b9-d19a47f8e8ea' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '70ce3726-7034-4f40-8edd-72eef6faf2ab' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '2c239590-8e9a-4871-aaac-b17dbb72e380' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '7bb2cf92-f484-4132-a4bb-885e7a00b7f9' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '41f75079-6928-4e70-8c89-1b671f64b780' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '3e579903-b52d-47d4-871d-f91661867774' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT 'ab965b2d-fd36-4f2c-a098-9f7b81d7bac0' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '8278c8ea-3750-4ede-9188-ff8c15861421' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '168688b7-e971-4dde-b756-c4f5a544623c' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '289cff83-751e-4d89-9d07-726a2a5348ce' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
...
MERGE INTO role t
USING (SELECT '8fe213ad-5d74-4774-a2cb-b6134228453f' AS publicId FROM DUAL) s
ON (t.publicId = s.publicId)
WHEN MATCHED THEN
